...
namespace HeneGames.Airplane
{
    ...
    public class SimpleAirPlaneController : MonoBehaviour
    {
        ...
        private void FlyingUpdate()
        {
            ...
            //Crash
            if (!planeIsDead && HitSometing() && airplaneState != AirplaneState.Landing)
            {
                Crash();
            }
        }
        ...
        private void Crash()
        {
            ...
            Transform mainCamera = this.gameObject.transform.Find("Camera system");
            Transform cameraLookPoint = this.gameObject.transform.Find("Camera look point");
            cameraLookPoint.parent = null;
            mainCamera.parent = null;
            res.shouldReset = true;
            Destroy(mainCamera.Find("Camera settings").gameObject);
